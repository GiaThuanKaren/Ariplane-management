...
public class FlightRoutesList implements ListInterface{
	FlightRoutes[] fl =new FlightRoutes[0];
	int n;
    ...
    public void remove() {
    	...
    	System.out.println("||3. Xoa theo san bay ha canh         ");
    	System.out.println("-----------------***-------------------");
