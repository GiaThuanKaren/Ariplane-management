...
public class StaffList {
	...
	public Staff[] staff = new Staff[0];
	private int n;
		...
		boolean flag;
			do {
				...
				for(int k = 0; k < staff.length; k++){
 	                if(staff[k].getStaffId().equals(f_id)){
 	                    flag = true;
 	                    t = k;
 	                    break;
 	                }
