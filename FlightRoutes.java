...
public class FlightRoutes { // TUYEN BAY
	...
	public void output() {
		System.out.print("| "+flightRouteId+tableOutput(flightRouteId, 12)
		+takeOffAirport+tableOutput(takeOffAirport, 16)
		+landingAirport+tableOutput(landingAirport, 16)
		+takeOffTime+tableOutput(takeOffTime, 13)
		+landingTime+tableOutput(landingTime, 13)
				);
		
	}
	
	public void writeFile() throws IOException{
		 DataOutputStream outStream = new DataOutputStream(new FileOutputStream("flightroutesoutput.txt", Boolean.TRUE));
