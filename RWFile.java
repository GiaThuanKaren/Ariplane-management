...
public class RWFile {
        ...
        try {
            ...
            try {
                while (true) { // xin cap phat them
                    ...
                    Flight temp = new Flight(flightId, routeId, flightRouteId, airplaneId, status,
    ...
    public void writeFile(FlightList flight, String path) throws IOException {
        ...
        for (int i = 0; i < flight.flight.length; i++) {
...
//    	BufferedReader rd= new BufferedReader(new File(path));
//    	String s
//    	
//    	
//        try {
...
//                            int ticketType = inputStream.readInt();
//                            int ticketPrice = inputStream.readInt();
//                            int chairNumber = inputStream.readInt();
...
//    }
    ...
    public void writeFile(FlightTicketList flightTicket, String path) throws IOException{
        DataOutputStream outStream = new DataOutputStream(new FileOutputStream(path));
        for (int i = 0; i < flightTicket.flightTicket.length; i++) {
            flightTicket.flightTicket[i].writeFile();
        }
        outStream.close();
    }
    ...
    public void readFile(FlightTicketList fl,String path) {
    	try {
