...
public class AirplaneCompanyList {
    int n;
    AirplaneCompany[] airplaneCompanyList = new AirplaneCompany[0];
    ...
    public void input() {
        ...
        for (int i = 0; i < n; i++) {
            ...
            System.out.println("Airplane company " + (i + 1) + ": ");
    ...
    public void output(){
        ...
        System.out.println("|---------------------|---------------------------------------|");
//        System.out.println("--- Kich Thuoc " +airplaneCompanyList.length );
       
        for (int i = 0; i < this.airplaneCompanyList.length; i++) {
//        	System.out.println("| " +this.airplaneCompanyList[i].getAirplaneCompanyID() +"  " +this.airplaneCompanyList[i].getAirplaneCompanyName() +" |" );
...
//    	System.out.println(ac.getAirplaneCompanyID());
        n = airplaneCompanyList.length;
        airplaneCompanyList = Arrays.copyOf(airplaneCompanyList, n + 1);
        airplaneCompanyList[n] = new AirplaneCompany(ac);
//        airplaneCompanyList[n].output();
