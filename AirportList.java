    			...
    			if(flag==true) {
        	        ...
        	        switch(c) {
        	        	case 1:{
        	        		...
        	        		String find=sc1.nextLine();
        	        		airlist[t].setAirportID(find);
        	        		System.out.println("Da sua ma san bay thanh cong ");
        	        		flag=true;
        	        		break;
        	        	}
        	        	...
        	        	case 3:{
        	        		...
        	        		String find=sc1.nextLine();
        	        		airlist[t].setCity(find);
        	        		System.out.println(" Da sua ten thanh pho thanh cong");
        	        		flag=true;
        	        		break;
        	        	}
        	        	default:{
