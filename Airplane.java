...
public class Airplane {
    ...
    public Airplane(Airplane airplane) {
    	this.airplaneID=airplane.airplaneID ;
    	this.airplaneName=airplane.airplaneName;
    	this.numberOfSeats=airplane.numberOfSeats;
    	this.description=airplane.description;
    	this.airplaneCompanyID=airplane.airplaneCompanyID;
    }
    ...
    public void writeFile()throws IOException{
            DataOutputStream outStream = new DataOutputStream(new FileOutputStream("airplaneBin.txt", Boolean.TRUE));
