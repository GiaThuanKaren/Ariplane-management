...
public class CustomerTicket {
    ...
    public CustomerTicket(CustomerTicket customerTicket) {
    	this.customerTicketID=customerTicket.customerTicketID ;
    	this.customerID=customerTicket.customerID ;
    	this.ticketID=customerTicket.ticketID ;
    	this.boardingTime=customerTicket.boardingTime;
    	this.seatNumber=customerTicket.seatNumber;
    }
    ...
    public void writeFile(){
        try {
            DataOutputStream outStream = new DataOutputStream(new FileOutputStream(".\\Source\\customerticket.txt", Boolean.TRUE));
