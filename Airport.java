...
public class Airport { // SAN BAY
	...
	public void output() {
		System.out.print("| "+airportID +tableOutput(airportID, 10)
		+airportName +tableOutput(airportName, 15)
		+city + tableOutput(city, 15));
//		System.out.println("|-------------|-------------|--------------|--------------|-------------|------------|---------------|-------------|--------------|");
	}
	
	public void writeFile() throws IOException{
		DataOutputStream outStream = new DataOutputStream(new FileOutputStream("airportoutput.txt", Boolean.TRUE));
