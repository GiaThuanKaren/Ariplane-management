            ...
            do {
            	t = -1;
                 ...
                 for(int k = 0; k < customer.length; k++){
 	                if(customer[k].getCustomerId().equals(f_id)){
 	                    flag = true;
 	                    t = k;
 	                    break;
 	                }
                ...
                if(flag == true)
                {
                    ...
                    switch(c) {
                        case 1:
                        {
                            ...
                            customer[t].setCustomerId(nf_id);
                        ...
                        case 2:
                        {
                            ...
                            customer[t].setCustomersurName(nr_id);
                        ...
                        case 3:
                        {
                            ...
                            customer[t].setCustomerName(nfr_id);
                        ...
                        case 4:
                        {
                            ...
                            customer[t].setPhoneNumber(np_id);
                        ...
                        case 5:
                        {
                            ...
                            customer[t].setIdentityCart(ntod);
