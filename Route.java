...
public class Route { //LO TRINH
	...
	public void output(){
		System.out.print("| " + routeID +tableOutput(routeID, 20)
		+ routeName + tableOutput(routeName, 20));
		
		
	}
	
	public void writeFile() throws IOException{
		DataOutputStream outStream = new DataOutputStream(new FileOutputStream("routeoutput.txt", Boolean.TRUE));
