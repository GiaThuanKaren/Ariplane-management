...
public class AirplaneCompany {
    ...
    public AirplaneCompany(AirplaneCompany airplaneCompanys) {
    	this.airplaneCompanyID = airplaneCompanys.getAirplaneCompanyID();
    	this.airplaneCompanyName = airplaneCompanys.getAirplaneCompanyName();
    }

    public String getAirplaneCompanyID() {
        return this.airplaneCompanyID;
    }
    ...
    public String getAirplaneCompanyName() {
        return this.airplaneCompanyName;
    }

    public void setAirplaneCompanyName(String airplaneCompanyNames) {
        this.airplaneCompanyName = airplaneCompanyNames;
    }
    ...
    public void output() {
//    	System.out.println(this.airplaneCompanyID  );
    ...
    public void writeFile() {
        try {
            DataOutputStream outStream = new DataOutputStream(new FileOutputStream("airplanecompanyBin.txt", Boolean.TRUE));
