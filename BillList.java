		...
		boolean flag;
			do {
				...
				for(int k = 0; k < bill.length; k++){
	                if(bill[k].getBillId().equals(f_id)){
	                    flag = true;
	                    t = k;
	                    break;
	                }
