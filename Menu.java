...
public class Menu {
	static String Basic="D:\\JAVA\\First\\src\\ThiHK1\\";
	static String pathFlight =Basic+"flight.txt"; // oke
	static String pathCustomer =Basic+"CustomerBin.txt"; // oke
	static String pathRoute = Basic+"route1.txt"; // oke
	static String pathFlightRoute =Basic +"flightRoute1.txt"; // oke
	static String pathAirplaneCompany =  Basic +"airplanecompanyBin.txt";  // oke
	static String pathAirport = Basic+"airport1.txt"; //oke
	static String pathStaff = Basic+"staff.txt"; // oke
	static String pathAirplane =Basic+ "airplane.txt"; // oke
	static String pathFlightTicket =Basic+ "flightTicket.txt"; // oke
	
	
	
	static String pathCustomerTicket = "customerTicket.txt";
	static String pathBill = "bill.txt";
	...
	public static void menuchinh() throws IOException 
	{
		...
		System.out.println("|| 14. Show Info                           ||");
		System.out.println("|| 0. Quit                                 ||");
		System.out.println("||=========================================||");
		System.out.println("");
		System.out.print("Nhap lua chon : ");
		int c=in.nextInt();
		c=kiemtranhap(c,0,14);
		switch(c)
		{
			case 1:
			{
//				docghi();
	...
	// 	System.out.println("||                                                 ||");
	// 	System.out.println("||============Chon muc ban can thao tac============||");
	// 	System.out.println("||1. Xem toan bo danh sach ve                      ||");
	// 	System.out.println("||2. Xem chi tiet cua mot ve                       ||");
	// 	System.out.println("||3. Them ve                                       ||");
	...
	// public static void banve()
	// {
	// 	// them 1 ve: them kh ,them phieu dat cho,them hoa don,nhap noi di noi den,xuat chuyen bay
	// 	//chon chuyen bay bang cach nhap ma chuyen bay
	// 	//goi ham them ve
	// 	//goi ham tao ds chi tiet hoa don
	// 	Scanner in=new Scanner(System.in);
	// 	CustomerList dskh=new CustomerList();
	// 	dskh.readFileAll();
	// 	BillList dshd= new BillList();
	// 	dshd.readFileAll();
	// 	FlightList dscb=new FlightList();
	// 	dscb.readFileAll();
	// 	FlightTicketList dsvmb=new FlightTicket();
	// 	dsvmb.readFileAll();
	...
	// 	System.out.println("-----------|-------------|-------------|-------------|----------------|----------------|-----------------|-----------------");
	// 	System.out.println("|Ma may bay|Ma chuyen bay| Ma chang bay|    Ga di    |     Ga den     |  Thoi gian di  |  Thoi gian den  |  So ve con lai |");
	// 	System.out.println("|----------|-------------|-------------|-------------|----------------|----------------|-----------------|----------------|");
	// 	for(int i=0;i<dscb.getN();i++)
	// 		if(dscb.cb[i].getGadi().toLowerCase().indexOf(noidi.toLowerCase())!=-1
	// 			&& dscb.cb[i].getGaden().toLowerCase().indexOf(noiden.toLowerCase())!=-1)
	// 		{
	// 			dscb.cb[i].xuat();
	// 		}
	// 	dsvmb.them();
